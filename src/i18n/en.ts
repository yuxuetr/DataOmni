...
export const en: Translations = {
  ...
  'error.backend.sqlServerUnsupported': 'SQL Server does not support this operation yet. Support is arriving in stages; the SQL Server tile in the connection form lists what is not available yet.',
