...
export const en: Translations = {
  ...
  'redis.element.binaryReadOnly': 'Not UTF-8 text: it can be deleted but not edited here',
  ...
  'redis.value.binary': 'Not UTF-8 text: shown escaped the way redis-cli does (\\xff is one byte).',
  ...
  'redis.binaryKey': 'The key is not UTF-8 text and is shown escaped',
